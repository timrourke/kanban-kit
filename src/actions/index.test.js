...
it('should create action for "createBoard"', () => {
  const action = actions.createBoard('foo');
...
it('should create action for "updateBoard"', () => {
  const action = actions.updateBoard('some-id', 'foo');
...
it('should create action for "createColumn"', () => {
  const action = actions.createColumn('foo');
...
it('should create action for "updateColumn"', () => {
  const action = actions.updateColumn('some-id', 'foo', 7);
